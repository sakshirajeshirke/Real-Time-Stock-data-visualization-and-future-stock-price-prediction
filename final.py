...
with st.sidebar:
    ...
    tickers = st.multiselect(
        ...
        options=["AAPL", "MSFT", "GOOGL", "TSLA", "NVDA", "AMZN", "META",
                ...
                "ICICIBANK.NS", "SBIN.NS", "HINDUNILVR.NS", "ITC.NS", "LT.NS"],
        default=default_tickers,
        help="Select multiple stocks to analyze (e.g., AAPL = Apple, RELIANCE.NS = Reliance Industries)"
    )
...
def plot_technical_indicators(df, indicators, ticker):
    ...
    currency_label = 'Price (INR)' if is_indian else 'Price (USD)'
                    ...
                    with tab1:
                        ...
                        with col1:
                            ...
                            <div class="metric-card">
                                <h4>Latest Close</h4>
                                <p style="font-size: 24px; font-weight: bold;">{currency_symbol}{df['Close'].iloc[-1]:.2f}</p>
                            </div>
                            """, unsafe_allow_html=True)
                        ...
                        with col3:
                            ...
                            <div class="metric-card">
                                <h4>52-Week High</h4>
                                <p style="font-size: 24px; font-weight: bold;">{currency_symbol}{df['High'].max():.2f}</p>
                            </div>
                            """, unsafe_allow_html=True)
                        ...
                        with col4:
                            ...
                            <div class="metric-card">
                                <h4>52-Week Low</h4>
                                <p style="font-size: 24px; font-weight: bold;">{currency_symbol}{df['Low'].min():.2f}</p>
                            </div>
                            """, unsafe_allow_html=True)
                    ...
                    with tab3:
                        ...
                        with st.spinner(f"⏳ Training LSTM model for {ticker}..."):
                            ...
                            with col1:
                                ...
                                <div class="metric-card">
                                    <h4>Current Price</h4>
                                    <p style="font-size: 24px; font-weight: bold;">{currency_symbol}{last_price:.2f}</p>
                                </div>
                                """, unsafe_allow_html=True)
                            ...
                            with col2:
                                ...
                                <div class="metric-card">
                                    ...
                                    <p style="font-size: 24px; font-weight: bold;">{currency_symbol}{future_price:.2f}</p>
                                </div>
                                """, unsafe_allow_html=True)
